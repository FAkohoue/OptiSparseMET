...
make_example_sparsemet_data <- function(seed = 123) {
  ...
  env_design_specs <- list(
    ...
    # Env1: p-rep design via met_prep_famoptg().
    ...
    # n_reps = 2 on an 8 x 10 grid. min_block_size = 8 (= 6 entry slots + 2 checks)
    # ensures incomplete blocks are not too small.
    ...
    # Env3: augmented repeated-check design via met_prep_famoptg().
